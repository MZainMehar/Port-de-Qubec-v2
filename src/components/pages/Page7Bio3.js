...
export default function Page7Bio3() {
  ...
  return (
    <div style={{
      ...
      {showPdf && (
        <PDFPopup src={c.pdf} onClose={() => setShowPdf(false)} closeLabel={c.closeLabel} />
      )}
    </div>
  );
}
