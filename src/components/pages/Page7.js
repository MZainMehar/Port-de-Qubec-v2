...
const CONTENT = {
  ...
  en: {
    ...
    items: [
      ...
      { id: PAGES.PAGE_7_BIO_3, label: 'Greening plan',                         thumb: '/images/THUMB -Verdissement3 - Copy.jpg' },
      { id: PAGES.PAGE_7_BIO_4, label: 'Environmental DNA Sampling',            thumb: '/images/THUMB - Recolte Adn environnemental - Copy.jpg' },
    ],
  },
};
  ...
  return (
    <PageShell>
      ...
      <div className="bio-grid animate-fade-in stagger-2">
        {c.items.map((item) => (
          <div key={item.id} className="bio-card" onClick={() => navigate(item.id)}>
